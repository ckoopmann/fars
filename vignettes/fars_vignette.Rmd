...
# Data
The data is supposed to be saved in *.csv.bz2* files with the filename *accident_YEAR.csv.bz2* with *YEAR* replaced with the respective year in 4 digits.
The data should have the following structure (first six rows of data as saved in *inst/extdata/accident_2013.csv.bz2*):
```{R, results = "asis", message = FALSE}
example_data = fars::fars_read(file.path('..','inst','extdata','accident_2013.csv.bz2'))
pander::pandoc.table(head(example_data))
```
# Functions
